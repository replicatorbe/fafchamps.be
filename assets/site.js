...
(function(){ try{
  ...
  const FS={type:'dir',children:{
    ...
    'skills.txt':{type:'file',content:[
      ...
      '  Prod communale : Windows Server (AD, GPO, RDS), Microsoft 365 et',
      '  Defender, Veeam, NinjaOne, VoIP, applicatifs métier, NIS2',
      '  Chez moi : Linux (Debian), Docker, nginx, PHP, Bash, PowerShell,',
      '  Git, MySQL',
  ...
  const C={
    ...
    skills:()=>['<span class="green">[ EN SERVICE ]</span> cette semaine',
      '  <span class="res">prod communale</span> — Windows Server (AD, GPO, RDS) · Microsoft 365 &amp; Defender',
      '  Veeam · NinjaOne · VoIP · applicatifs métier · NIS2',
      '  <span class="res">chez moi</span> — Linux (Debian) · Docker · nginx · PHP · Bash · PowerShell',
      '  Git · MySQL · Réseau : TCP/IP, DNS, VPN, VLAN, pare-feu',
      '  Home Assistant · Jeedom · ESPHome',
