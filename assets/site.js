...
(function(){ try{
  ...
  const FS={type:'dir',children:{
    ...
    'skills.txt':{type:'file',content:[
      ...
      '  Veeam, NinjaOne, FortiGate et FortiClient EMS, VoIP,',
      '  applicatifs métier, NIS2',
      '  Linux (Debian), Docker, nginx, PHP, Bash, PowerShell, Git, MySQL',
      '  Réseau : TCP/IP, DNS, VPN, VLAN, segmentation',
  ...
  const C={
    ...
    skills:()=>['<span class="green">[ EN SERVICE ]</span> cette semaine',
      ...
      '  NinjaOne · FortiGate &amp; FortiClient EMS · VoIP · applicatifs métier · NIS2',
      '  Linux (Debian) · Docker · nginx · PHP · Bash · PowerShell · Git · MySQL',
      '  Réseau : TCP/IP, DNS, VPN, VLAN, segmentation',
      '  Home Assistant · Jeedom · ESPHome',
